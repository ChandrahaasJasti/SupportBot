...
load_dotenv(dotenv_path="/home/chandrahaas/codes/Bot/.env")
    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f""" You are an Information Retrieval Agent. You have access to various information retrieval tools.
Available tools:
{tools_description}
...
Make sure to provide parameters in the correct order as specified in the function signature."""
                ...
                query = """Who is the POC for insurance?"""
